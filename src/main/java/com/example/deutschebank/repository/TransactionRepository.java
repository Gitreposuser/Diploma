...
public interface TransactionRepository extends JpaRepository<Transaction, UUID> {
    ...
    List<Transaction> getTransactionsByAmountBetween(BigDecimal from, BigDecimal to);

    List<Transaction> getTransactionsByCreatedBetween(LocalDateTime from, LocalDateTime to);

    @Query("SELECT MIN(tr.amount) FROM Transaction tr " +
